# Login_local_ways
各种各样的在本地上实现最简单的登录操作的方式。
## 通过文件
[login_file.py](https://github.com/aoout/login_local_ways/blob/master/login_file.py)
## 通过mysql数据库
[login_mysql.py](https://github.com/aoout/login_local_ways/blob/master/login_mysql.py)
## 通过json
